...
from spotify_builder.schemas.base import PlaylistData, PlaylistSummary
from spotify_builder.schemas.composer import ComposerConfig, ComposerConfigItem, ComposerConfigListeningHistory


@patch("spotify_builder.managers.client.ClientManager.get_this_is_playlist")
@patch("spotify_builder.managers.client.ClientManager.get_tracks")
...
@patch("spotify_builder.managers.client.ClientManager.get_history_tracks")
